...
class ChessBoard:
	def __init__(self,setupType=0):
		...
		if setupType == 3:
			...
			self.squares[7] = ['e','e','e','wK','wQ','e','wT','e']
		#Testing Queen Mate- Carter Truyens
		if setupType == 4:
			self.squares[0] = ['e','e','e','e','e','e','e','e']
			self.squares[1] = ['e','e','e','e','e','e','e','e']
			self.squares[2] = ['e','e','e','e','e','e','e','e']
			self.squares[3] = ['e','e','e','bK','e','e','e','e']
			self.squares[4] = ['e','e','e','e','e','e','e','e']
			self.squares[5] = ['e','e','e','e','e','e','e','e']
			self.squares[6] = ['e','e','e','e','e','e','e','e']
			self.squares[7] = ['e','e','e','wK','wQ','e','e','e']

		#Rook Checkmate - Joshua Szkiba
		if setupType == 5:
			self.squares[0] = ['e','e','e','e','e','e','e','e']
			self.squares[1] = ['e','e','e','e','e','e','e','e']
			self.squares[2] = ['e','e','e','e','e','e','e','e']
			...
			self.squares[5] = ['e','e','e','e','e','e','e','e']
			self.squares[6] = ['e','e','e','e','e','e','e','e']
			self.squares[7] = ['e','e','e','wK','wR','e','e','e']

		#Knights Checkmate -Raiden Sohan
		if setupType == 6:
			self.squares[0] = ['e','e','e','e','e','e','e','e']
			self.squares[1] = ['e','e','e','e','e','e','e','e']
			self.squares[2] = ['e','e','e','bK','e','e','e','e']
			self.squares[3] = ['e','e','e','e','e','e','e','e']
			self.squares[4] = ['e','e','e','e','e','e','e','e']
			self.squares[5] = ['e','e','e','e','e','e','e','e']
			self.squares[6] = ['e','e','e','e','e','e','e','e']
			self.squares[7] = ['e','e','wT','wK','wT','e','e','e']
			
		#Bishops Checkmate - Carson Kaucher
                if setupType == 7:
                       self.squares[0] = ['e','e','e','e','e','e','e','e']
                       self.squares[1] = ['e','e','e','e','e','e','e','e']
                       self.squares[2] = ['e','e','e','e','e','e','e','e']
                       ...
                       self.squares[5] = ['e','e','e','e','e','e','e','e']
                       self.squares[6] = ['e','e','e','e','e','e','e','e']
                       self.squares[7] = ['e','e','e','wK','wB','wB','e','e']

                #Pawn Checkmate -Yashwanth Gunturi 
		if setupType == 8:
			self.squares[0] = ['e','e','e','e','e','e','e','e']
			self.squares[1] = ['e','e','e','e','e','e','e','e']
			self.squares[2] = ['e','e','e','e','bK','e','e','e']
			self.squares[3] = ['e','e','e','e','e','e','e','e']
			self.squares[4] = ['e','e','e','e','e','e','e','e']
			self.squares[5] = ['e','e','e','e','wP','e','e','e']
			self.squares[6] = ['e','e','e','e','e','e','e','e']
			self.squares[7] = ['e','e','e','wK','e','e','e','e']
