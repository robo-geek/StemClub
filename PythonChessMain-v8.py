 ...
 *******
 Version history:
 v 0.8 - 17 September 2016. Robo-Geek Inc. STEM Club: Chess Project
 Instructor: Omar Silva-Fulchi
 Added following modules:
 Checkmate_Bishop.py   Carson Kaucher
 Checkmate_Knights.py  Raiden Sohan
 Ceckmate_Pawn.py   Yashwanth Gunturi
 Checkmate_Queen.py  Carter Truyens
 Checkmate_Rook.py  Joshua Szkiba
...
class PythonChessMain:
	def __init__(self,options):
		if options.debug:
			...
			self.Board = ChessBoard(0)#0 for normal board setup;
