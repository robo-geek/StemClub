 ...
 *******
 ...
 it under the terms of the GNU General Public LicensXDe as published by 
 ...
 *******
 ...
 v 0.8 - 20 september 2016. robogeek inc carter
...
class PythonChessMain:
	def __init__(self,options):
		if options.debug:
			...
			self.Board = ChessBoard(4)#4 for checkmate with queen board setup; see ChessBoard class for other options (for testing purposes)
