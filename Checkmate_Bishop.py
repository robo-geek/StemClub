 ...
 *******
 Version history:
 v 0.8 - 20 September 2016. STEM Club: Checkmate Bishop by Carson
...
class PythonChessMain:
	def __init__(self,options):
		if options.debug:
			...
			self.Board = ChessBoard(7)#7 for Bishops Checkmate setup; see ChessBoard class for other options (for testing purposes)
