 ...
 *******
 ...
 v 0.8 - 17 September 2016. Robo-Geek Inc. STEM Club: Project
 Raiden Sohan
...
class PythonChessMain:
	def __init__(self,options):
		if options.debug:
			...
			self.Board = ChessBoard(6)#6 for Checkmate with knights setup; see ChessBoard class for other options (for testing purposes)
