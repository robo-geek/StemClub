...
v 0.8 - 20 september 2016. Robo-Geek INC. STEM Class: Chess Project
...
class PythonChessMain:
	def __init__(self,options):
		if options.debug:
			...
			self.Board = ChessBoard(5)#5 for normal board setup; see ChessBoard class for other options (for testing purposes)
